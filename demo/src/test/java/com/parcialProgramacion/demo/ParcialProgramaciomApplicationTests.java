...
import com.parcialProgramacion.demo.service.MutantService;
...
class ParcialProgramaciomApplicationTests {
	...
	// Caso 4: No mutante
	@Test
	void testNoMutante2() throws Exception {
		String[] noMutante2 = {"AAAA", "AAAA", "AAAA", "AAAA"};
		assertFalse(mutantService.analyzeDna(noMutante2));
	}
	...
	void testMutante3() throws Exception {
		...
		assertTrue(mutantService.analyzeDna(mutante3));
	}
